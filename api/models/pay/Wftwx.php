...
Class Wftwx{
    ...
    public static function submitOrderInfo($submitData){
        ...
        static::$reqHandler->setParameter('service','pay.weixin.native');//接口类型
        static::$reqHandler->setParameter('mch_id',static::$cfg->C('mchId'));//必填项，商户号，由平台分配
        static::$reqHandler->setParameter('notify_url','http://' . $_SERVER['HTTP_HOST'] . '/Pay/notify/paytype/Wftwx');
