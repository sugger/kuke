...
use partner\models\User;
use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use partner\models\Order;
/**
 * OrderSearch represents the model behind the search form about `partner\models\Order`.
 */
class OrderSearch extends Order
{
    public $from_date,$to_date,$sumMoney;
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query =(new \yii\db\ActiveQuery(Order::className()));
        ...
        $query->andFilterWhere([ 'channel'=>Yii::$app->user->getIdentity()->getId()]);
