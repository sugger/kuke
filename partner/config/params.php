...
return [
    ...
    /* 后台错误页面模板 */
    'action_error'     =>  '@partner/views/public/error.php', // 默认错误跳转对应的模板文件
    'action_success'   =>  '@partner/views/public/success.php', // 默认成功跳转对应的模板文件
    /* UEditor编辑器配置 */
    'ueditorConfig' => [
        /* 图片上传配置 */
        'imageRoot'            => Yii::getAlias("@partner/web/image/"), //图片path前缀
        ...
        /* 文件上传配置 */
        'fileRoot'             => Yii::getAlias("@partner/web"), //文件path前缀
