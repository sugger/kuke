...
/* @var $searchModel partner\models\search\PartnerGameSearch */
...
//        'filterModel' => $searchModel,
        'columns' => [
            ...
            [
                'attribute' => 'rate',
                'value' => function($model){
                    return ($model->rate?$model->rate*100:'默认:'.(Yii::$app->user->getIdentity()->rate * 100)) .'%' ;
                }
            ],
            [
             ...
             [
                 ...
                 'value' => function($model){
                     if ($model->auto_server==1) {
                         ...
                         return Html::tag('span','停服禁用',['class'=>'badge']);
                     }
            ...
            [
                ...
                'buttons' => [
                    'addsub' => function ($url, $model, $key) {
                        return $model->auto_server==\partner\models\PartnerGame::AUTO_DISABLE?
                            Html::a('<i class="fa fa-edit"></i>', ['partner-server/create', 'pid'=>$model['partnerid'],'gid'=>$model['gid']], [
