...
/* 加载页面级别资源 */
\partner\assets\Select2Asset::register($this);
?>
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        <?=$form->field($model, 'pid')->selectList(
            ArrayHelper::merge(['0'=>'一级栏目'],ArrayHelper::listDataLevel( \partner\models\Menu::find()->asArray()->all(), 'id', 'title','id','pid')),
