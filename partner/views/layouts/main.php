...
//echo "<pre>";
//print_r(Menu::getMenus($route)['child']);die;
$allMenu['main']=[
        ['title'=>'首页','url'=>'index/index','group'=>'',],
        ['title'=>'消息','url'=>'article/index','group'=>'',],
        ['title'=>'订单','url'=>'order/index','group'=>'',],
        ['title'=>'用户','url'=>'user/index','group'=>'',],
        ['title'=>'游戏','url'=>'partner-game/index','group'=>'',],
];
$allMenu['child']=$this->context->child;
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li><a href="<?=Url::toRoute('index/myinfo')?>"><i class="icon-user"></i> 个人主页 </a></li>
                                ...
                                <li><a href="<?=Url::toRoute('public/logout')?>"><i class="icon-key"></i> 注销 </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown dropdown-quick-sidebar-toggler">
                            <a href="<?=Url::toRoute('public/logout')?>" class="dropdown-toggle">
