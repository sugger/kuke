...
/**
 * PartnerGameSearch represents the model behind the search form about `backend\models\PartnerGame`.
 */
class PartnerGameSearch extends PartnerGame
{
    public $partnerName;
    /**
     * @inheritdoc
    ...
    public function rules()
    {
        return [
            ...
            [['partnerName','gkey', 'lkey', 'pkey', 'create_time', 'up_time', 'url_web', 'url_pay', 'url_fcm', 'url_bbs', 'url_kefu', 'url_client'], 'safe'],
